...
public class FieldCentricMecnaum extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Front Right Power", frontRightMotor);
            telemetry.addData("Back Right Power", backRightMotor);
        }
    }
}


//alt to the math double rotX = x * Math.cos(botHeading) - y * Math.sin(botHeading);